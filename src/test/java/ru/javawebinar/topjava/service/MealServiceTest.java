...
public class MealServiceTest {
    ...
    @Test
    public void get() {
        assertMatch(service.get(adminMeal9.getId(), ADMIN_ID), adminMeal9);
    }
    ...
    public void deleteAnotherUserMeal() {
        assertThrows(NotFoundException.class, () -> service.delete(adminMeal9.getId(), USER_ID));
    }
    ...
    public void updateAnotherUserMeal() {
        assertThrows(NotFoundException.class, () -> service.update(new Meal(adminMeal9), USER_ID));
    }
    ...
    public void duplicateDateTimeCreate() {
        ...
        newUserMeal.setDateTime(userMeal7.getDateTime());
