...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.DATE_SORTED, query = "SELECT m FROM Meal m WHERE m.user.id =:user_id AND " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String DATE_SORTED = "Meal.getBetweenDateSorted";
